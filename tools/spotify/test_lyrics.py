...
Usage:
    python3 tools/spotify/test_lyrics.py "Track Name" "Artist"
    python3 tools/spotify/test_lyrics.py "Bohemian Rhapsody" "Queen"
    python3 tools/spotify/test_lyrics.py "Never Gonna Give You Up" "Rick Astley" 213
"""
