...
ALL_SERVICES=(
    ...
    "beo-player-wiim.service"
    "beo-player-mozart.service"
    "beo-player-ase.service"
...
SERVICE_DESC["beo-player-wiim.service"]="WiiM / LinkPlay Player (Port 8766)"
SERVICE_DESC["beo-player-mozart.service"]="B&O Mozart Player (Port 8766)"
SERVICE_DESC["beo-player-ase.service"]="B&O ASE Player (Port 8766)"
...
OPTIONAL_SOURCES=(
    ...
    "JELLYFIN|beo-source-jellyfin.service|🎵|Jellyfin source"
