...
logger = logging.getLogger("beo-router.volume.hdmi")

DEFAULT_CARD = "vc4hdmi1"
DEFAULT_CONTROL = "Playback"


class HdmiVolume(VolumeAdapter):
    ...
    async def get_volume(self) -> float:
        ...
        # Parse e.g. "[75%]" from amixer output
    ...
    async def _flush(self):
        ...
        logger.info("-> HDMI1 volume: %.0f%%", vol)
